...
private fun Rucksack.intersect(other: Rucksack) : Set<Char> {
...
private fun Rucksack.intersect(other: Set<Char>) : Set<Char> {
    val returnList = mutableSetOf<Char>()
 ...
 * Compartment -------------------------------------------------------------------
 */
private data class Compartment(val itemList: MutableList<Char> = mutableListOf()) {
    fun contains(c: Char) : Boolean {
        return itemList.contains(c)
    }
}

private fun Compartment.intersect(other: Compartment) : Set<Char> {
 ...
 * Misc -------------------------------------------------------------------
 */
private fun String.toDeque() : ArrayDeque<Char> {
